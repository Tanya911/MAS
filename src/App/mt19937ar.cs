...
;			 
        ...
        #region "Get real number"
        /* generates a real random number on (a,b) */
        public double genrand_RealInInterval(double a, double b)
        {
            return genrand_real3() * (b - a) + a;
        }
        #endregion

        #region "Get Int31 number"
        /* generates a random number on [a,b]-int-Interval */
        public int genrand_IntInInterval(int a, int b)
        {
            return (int)(genrand_real1() * (b - a) + a);
        }
        #endregion
